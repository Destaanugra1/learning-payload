...
export default async function KopiPage() {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {kopiData.docs.map((kopi, index) => (
            ...
            >
                {/* IMAGE */}
                <div className="relative w-full aspect-4/3overflow-hidden">
                    {(() => {
                        const media = kopi.name_kopi && typeof kopi.name_kopi === 'object' ? kopi.name_kopi : null;
